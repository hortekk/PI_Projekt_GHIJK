...
namespace Baza
{
    public class Administrator
    {
        ...
        /// <summary>
        /// Dohvaća administratora iz baze prema ID
        /// </summary>
        /// <returns>Administrator</returns>
        public static Administrator DohvatiPremaID(string ID)
        {
            string sqlUpit = "SELECT * FROM Administrator WHERE idAdmin = " + ID;
        ...
        public static bool Provjeri(string ulazKorisnik, string ulazBaza)
        {
            ...
            if (String.Equals(ulazKod, ulazBaza, StringComparison.CurrentCultureIgnoreCase)) return true;
            return false;
        }
